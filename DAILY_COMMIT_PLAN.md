...
1. `test: add edge-case coverage for dataset leakage`
2. `feat: expose configuration for LoRA hyperparameters`
...
7. `perf: benchmark and optimise inference throughput`
